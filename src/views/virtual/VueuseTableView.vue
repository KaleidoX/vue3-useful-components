...
import VueuseTable from '@/components/virtual/vueuse/VueuseTable.vue'

defineOptions({ name: 'VirtualVueuseTableView' })
...
<template>
  <VirtualDemoLayout
    ...
    title="VueUse useVirtualList 表格"
    show-editable
  >
    <VueuseTable :data="data" :content-type="contentType" @update:cell="handleCellUpdate" />
  </VirtualDemoLayout>
</template>
