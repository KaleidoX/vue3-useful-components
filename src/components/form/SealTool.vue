    ...
    <Teleport to="body">
      ...
      >
        <div class="w-[480px] rounded-xl bg-white p-6 shadow-2xl">
          <h3 class="mb-4 flex items-center gap-2 text-lg font-semibold">插入电子签章</h3>
          <p class="mb-2 text-xs text-gray-400">
            选择纯色背景的印章图片，自动提取。全程本地处理，无需上传服务器。
          </p>
          <div
            class="h-[240px] flex cursor-pointer items-center justify-center overflow-hidden border-2 border-blue-300 rounded border-dashed bg-gray-50"
            @click="selectImage"
          >
